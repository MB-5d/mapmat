...
const ACTIONS = Object.freeze({
  ...
  MAP_LIST: 'map.list',
  MAP_READ: 'map.read',
  MAP_ACTIVITY_LIST: 'mapActivity.list',
  ...
  MAP_VERSION_UPDATE: 'mapVersion.update',
  ...
  COLLAB_MEMBERSHIP_LIST: 'collabMembership.list',
  COLLAB_MEMBERSHIP_UPSERT: 'collabMembership.upsert',
  COLLAB_MEMBERSHIP_DELETE: 'collabMembership.delete',
  COLLAB_INVITE_LIST: 'collabInvite.list',
  COLLAB_INVITE_CREATE: 'collabInvite.create',
  COLLAB_INVITE_REVOKE: 'collabInvite.revoke',
  COLLAB_SETTINGS_READ: 'collabSettings.read',
  COLLAB_SETTINGS_UPDATE: 'collabSettings.update',
  ACCESS_REQUEST_LIST: 'accessRequest.list',
  ACCESS_REQUEST_CREATE: 'accessRequest.create',
  ACCESS_REQUEST_REVIEW: 'accessRequest.review',
...
const FEATURES = Object.freeze({
  ...
  COLLAB_PANEL_VIEW: 'collab.panel.view',
  COLLAB_INVITE_SEND: 'collab.invite.send',
  COLLAB_SETTINGS_MANAGE: 'collab.settings.manage',
  ACCESS_REQUESTS_VIEW: 'access.requests.view',
  ACCESS_REQUESTS_CREATE: 'access.requests.create',
...
const ACTION_ROLE_MATRIX = Object.freeze({
  ...
  [ACTIONS.MAP_ACTIVITY_LIST]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.MAP_COMMENT]: [ROLES.OWNER, ROLES.EDITOR, ROLES.COMMENTER],
  [ACTIONS.MAP_CREATE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.MAP_UPDATE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.MAP_DELETE]: [ROLES.OWNER],

  [ACTIONS.MAP_VERSION_LIST]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.MAP_VERSION_CREATE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.MAP_VERSION_UPDATE]: [ROLES.OWNER, ROLES.EDITOR],
  ...
  [ACTIONS.COLLAB_MEMBERSHIP_LIST]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_MEMBERSHIP_UPSERT]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_MEMBERSHIP_DELETE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_INVITE_LIST]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_INVITE_CREATE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_INVITE_REVOKE]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_SETTINGS_READ]: [ROLES.OWNER, ROLES.EDITOR],
  [ACTIONS.COLLAB_SETTINGS_UPDATE]: [ROLES.OWNER],
  [ACTIONS.ACCESS_REQUEST_LIST]: [ROLES.OWNER],
  [ACTIONS.ACCESS_REQUEST_CREATE]: [ROLES.OWNER, ROLES.EDITOR, ROLES.COMMENTER, ROLES.VIEWER, ROLES.NONE],
  [ACTIONS.ACCESS_REQUEST_REVIEW]: [ROLES.OWNER],

  [ACTIONS.PRESENCE_LIST]: [ROLES.OWNER, ROLES.EDITOR, ROLES.COMMENTER, ROLES.VIEWER],
  [ACTIONS.PRESENCE_HEARTBEAT]: [ROLES.OWNER, ROLES.EDITOR, ROLES.COMMENTER, ROLES.VIEWER],
  [ACTIONS.PRESENCE_MANAGE]: [ROLES.OWNER, ROLES.EDITOR],
});

const FEATURE_ACTION_MAP = Object.freeze({
  [FEATURES.PROJECT_MANAGE]: ACTIONS.PROJECT_UPDATE,
  [FEATURES.MAP_VIEW]: ACTIONS.MAP_READ,
  [FEATURES.ACTIVITY_VIEW]: ACTIONS.MAP_ACTIVITY_LIST,
  [FEATURES.MAP_COMMENT]: ACTIONS.MAP_COMMENT,
  ...
  [FEATURES.COLLAB_PANEL_VIEW]: ACTIONS.COLLAB_MEMBERSHIP_LIST,
  [FEATURES.COLLAB_INVITE_SEND]: ACTIONS.COLLAB_INVITE_CREATE,
  [FEATURES.COLLAB_SETTINGS_MANAGE]: ACTIONS.COLLAB_SETTINGS_UPDATE,
  [FEATURES.ACCESS_REQUESTS_VIEW]: ACTIONS.ACCESS_REQUEST_LIST,
  [FEATURES.ACCESS_REQUESTS_CREATE]: ACTIONS.ACCESS_REQUEST_CREATE,
  [FEATURES.PRESENCE_VIEW]: ACTIONS.PRESENCE_LIST,
});
...
function resolveResourceRole({ actorUserId, resourceOwnerUserId, membershipRole = null } = {}) {
  ...
  if ([ROLES.OWNER, ROLES.EDITOR, ROLES.COMMENTER, ROLES.VIEWER].includes(normalizedMembership)) {
