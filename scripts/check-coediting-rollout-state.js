...
function createRolloutStateCompareConfig(env = process.env) {
  return {
    left: {
      ...
      healthUrl: env.COEDITING_LEFT_HEALTH_URL || 'https://api-staging.vellic.io/health/coediting',
      adminUrl: env.COEDITING_LEFT_ADMIN_URL || 'https://api-staging.vellic.io/api/admin/coediting',
      adminKey: env.COEDITING_LEFT_ADMIN_KEY || env.COEDITING_STAGING_ADMIN_KEY || '',
    },
    right: {
      label: env.COEDITING_RIGHT_NAME || 'production',
      healthUrl: env.COEDITING_RIGHT_HEALTH_URL || 'https://api.vellic.io/health/coediting',
      adminUrl: env.COEDITING_RIGHT_ADMIN_URL || 'https://api.vellic.io/api/admin/coediting',
