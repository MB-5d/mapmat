...
const appSemantics = {
  light: {
    ...
    'ui-button-brand-fill-disabled': 'var(--color-brand-600)',
    ...
    'ui-button-brand-quiet-disabled': 'var(--color-brand-600)',
    ...
    'ui-canvas-grid-dot': 'rgba(148, 163, 184, 0.55)',
  ...
  dark: {
    ...
    'ui-input-mono-border': 'var(--color-plum-400)',
    'ui-input-mono-border-hover': 'var(--color-plum-300)',
    ...
    'ui-canvas-grid-dot': 'rgba(159, 143, 184, 0.45)',
    ...
    'ui-overlay-shadow': 'var(--shadow-overlay)',
    'ui-focus-ring': 'var(--shadow-focus)',
    'shadow-card': '0 1px 3px rgba(180, 180, 180, 0.12), 0 1px 2px rgba(160, 160, 160, 0.08)',
    'shadow-raised': '0 4px 12px rgba(180, 180, 180, 0.12)',
    'shadow-canvas-control': '0 4px 12px rgba(180, 180, 180, 0.12)',
    'shadow-overlay': '0 12px 24px rgba(160, 160, 160, 0.18)',
    'shadow-modal': '0 20px 25px rgba(180, 180, 180, 0.12)',
    'shadow-drawer': '-12px 0 24px rgba(180, 180, 180, 0.12)',
    'shadow-soft': 'var(--shadow-raised)',
    'shadow-strong': 'var(--shadow-overlay)',
