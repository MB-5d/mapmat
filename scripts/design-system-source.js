...
const appSemantics = {
  ...
  dark: {
    ...
    'ui-overlay-shadow': 'var(--shadow-overlay)',
    'ui-focus-ring': 'var(--shadow-focus)',
    'shadow-card': '0 1px 2px rgba(0, 0, 0, 0.42), 0 0 0 1px rgba(255, 255, 255, 0.04)',
    'shadow-raised': '0 8px 20px rgba(0, 0, 0, 0.46), 0 0 0 1px rgba(255, 255, 255, 0.05)',
    'shadow-canvas-control': '0 8px 18px rgba(0, 0, 0, 0.42), 0 0 0 1px rgba(255, 255, 255, 0.05)',
    'shadow-overlay': '0 18px 42px rgba(0, 0, 0, 0.58), 0 0 0 1px rgba(255, 255, 255, 0.06)',
    'shadow-modal': '0 24px 60px rgba(0, 0, 0, 0.62), 0 0 0 1px rgba(255, 255, 255, 0.06)',
    'shadow-drawer': '-16px 0 36px rgba(0, 0, 0, 0.56), -1px 0 0 rgba(255, 255, 255, 0.05)',
    'shadow-soft': 'var(--shadow-raised)',
    'shadow-strong': 'var(--shadow-overlay)',
