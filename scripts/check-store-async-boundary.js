...
const STORE_CALL_PATTERN = /\b(authStore|projectStore|mapStore|historyStore|shareStore|usageStore|jobStore|pageStore|collaborationStore|presenceStore)\.([A-Za-z_][A-Za-z0-9_]*)\s*\(/g;
