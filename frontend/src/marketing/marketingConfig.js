...
export const MARKETING_PAGES = [
  ...
  page({
    ...
    cards: [
      ...
      { title: 'Dev & Engineering', text: 'Turn messy crawls, redirects, stale pages, and migration questions into a shared technical map.', pageId: 'use-cases-dev-engineering' },
